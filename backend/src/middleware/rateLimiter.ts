...
/**
 * Rate limiter for phone update endpoint
 * Prevents abuse of phone number updates
 */
export const phoneUpdateRateLimiter = rateLimit({
  windowMs: 60 * 60 * 1000, // 1 hour
  max: 5, // 5 attempts per hour
  message: {
    success: false,
    message: 'Trop de tentatives de mise à jour du téléphone. Veuillez réessayer plus tard.'
  },
  standardHeaders: true,
  legacyHeaders: false,
  keyGenerator: (req) => {
